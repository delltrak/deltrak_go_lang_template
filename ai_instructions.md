# Instruções para Geração Completa de Google Cloud Function em Go
...
5.  **Criar `.env.example`:** Criar um ficheiro `.env.example` com as variáveis de ambiente necessárias:
    ```dotenv
